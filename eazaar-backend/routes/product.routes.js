...
// add a product
router.post('/add', demoProtection, verifyToken, checkDemoMode, productController.addProduct);
// add all product
router.post('/add-all', demoProtection, verifyToken, checkDemoMode, productController.addAllProducts);
// get all products
...
// get Single Product
router.patch("/edit-product/:id", demoProtection, verifyToken, checkDemoMode, productController.updateProduct);

// manual inventory adjustment route
router.patch("/adjust-inventory/:id", demoProtection, verifyToken, checkDemoMode, productController.adjustInventory);
// get Products ByType
router.get('/:type', productController.getProductsByType);
// get Products ByType 
router.delete('/:id', demoProtection, verifyToken, checkDemoMode, productController.deleteProduct);
